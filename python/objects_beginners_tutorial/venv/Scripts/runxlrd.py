#!C:\datos\Dropbox\recursos_io\investigacion_operativa\areas\optimizacion\prog_lineal\modelos\codigo_y_pdfs\tutorial_principiantes\modelos\python\tutorial_principiantes_obj\venv\Scripts\python.exe
